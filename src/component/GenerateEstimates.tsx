...
import TemplateVehicleEstimates from "./common/TemplateVehicleEstimates";

export const estimates = (data: any) => {
  const {
    document_type,
    header = {},
    header_boxes = {},
  ...
  return (
    <Document style={{ display: "flex" }}>
      <Page size="LETTER" orientation="portrait" style={docStyles.page}>
        {/* header */}
        <TemplateHeader
          title={header?.title || "Rental Estimates"}
        ...
        >
          ...
          >
            <View style={{ rowGap: 15 }}>
              <TemplateVehicleEstimates vehicles={vehicle_info} />
            </View>
          </TemplateSection>
        </View>
