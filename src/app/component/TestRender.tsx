...
import TemplateHeaderBox from "./TemplateHeaderBox";
...
import TemplateVehicle from "./TemplateVehicle";
import RentalAgreement from "./RentalAgreement";
import SignatureComponent from "./SignatureComponent";
import DateComponent from "./DateComponent";
import TemplateHeader from "./TemplateHeader";
import TemplateSection from "./TemplateSection";
import TemplateRenterInfo from "./TemplateRenterInfo";
import TemplateVehicleDamage from "./TemplateVehicleDamage";
          ...
          <View style={{
            marginTop: 10
             ...
             <View style={{...style.row, justifyContent: 'space-between'}}>
                <SignatureComponent label="Renter's Signature"/>
